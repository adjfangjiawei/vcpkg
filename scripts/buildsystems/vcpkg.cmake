...
macro("${VCPKG_OVERRIDE_FIND_PACKAGE_NAME}" z_vcpkg_find_package_package_name)
    ...
    # message(STATUS "CurrentSourceDirInVcpkgToochainFile:${CMAKE_CURRENT_SOURCE_DIR}")
    # message(STATUS "SourceFileInVcpkgTooChainFile:${CMAKE_SOURCE_DIR}")
    # message(STATUS "SourceFileInVcpkgTooChainFile:${CMAKE_BINARY_DIR}")
    string(TOLOWER ${z_vcpkg_find_package_package_name} z_vcpkg_find_package_package_name_lower)
    execute_process(
        COMMAND sh -c "echo ${z_vcpkg_find_package_package_name_lower} >> ${CMAKE_BINARY_DIR}/packages.txt"
    )
